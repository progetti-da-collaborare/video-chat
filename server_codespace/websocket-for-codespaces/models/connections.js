...
const authConnection = makeNewConnection('mongodb://user:password@mongo:27017/mongo_auth?authSource=admin&directConnection=true');
const docsConnection = makeNewConnection('mongodb://user:password@mongo:27017/mongo_documents?authSource=admin&directConnection=true');
