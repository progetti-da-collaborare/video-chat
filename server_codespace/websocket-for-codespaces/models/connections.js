...
const authConnection = makeNewConnection('mongodb://user:password@mongo:27017/mongo_auth?authSource=admin&replicaSet=rs0&directConnection=true');
const docsConnection = makeNewConnection('mongodb://user:password@mongo:27017/mongo_documents?authSource=admin&replicaSet=rs0&directConnection=true');
